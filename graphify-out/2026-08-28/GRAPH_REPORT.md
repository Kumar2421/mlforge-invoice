...
## Corpus Check
- 133 files · ~712,867 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 531 nodes · 817 edges · 38 communities (30 shown, 8 thin omitted)
...
10. `Directory List Reference` - 10 edges
...
Cohesion: 0.06
Nodes (43): ClientsView(), historyStages, onTimeBadgeClass(), Dashboard(), DashboardProps, InvoicesView(), InvoicesViewProps, previewReminderStages (+35 more)
...
Cohesion: 0.09
Nodes (34): GET(), PATCH(), GET(), Params, POST(), completeReminderSequence(), PATCH(), GET() (+26 more)
...
Cohesion: 0.10
Nodes (30): AdminLayout(), GET(), ConnectionRow, GET(), SettingsRow, POST(), displayTime(), GET() (+22 more)
...
- **Why does `createClient()` connect `createClient` to `createAdminClient`?**
